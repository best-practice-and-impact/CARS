...
plot <- CARS::plot_freqs(tables$git_access, n = samples$all, xlab = "git access", ylab = "%", font_size = 14)
...
plot <- CARS::plot_freqs(tables$git_knowledge, n = samples$all, xlab = "git knowledge", ylab = "%", font_size = 14)
...
plot <- CARS::plot_freqs(tables$strategy_knowledge, n = samples$heard_of_RAP,
                         ...
                         xlab = "RAP strategy knowledge", ylab = "%", font_size = 14)
