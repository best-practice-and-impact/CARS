...
plot <- CARS::plot_stacked(tables$use, xlab = "Programming tool", colour_scale = "3scale", font_size = 14)
table <- CARS::df_to_table(tables$use, column_headers = c("Programming tool", "Yes", "No", "Don't know"), crosstab = TRUE)
