...
excluding respondents who have neither access or knowledge
...
This excludes respondents who are RAP champions themselves
...
plot <- CARS::plot_freqs(tables$basic_rap_scores, n = samples$code_at_work, bar_colour = c(255, 105, 0), xlab = "Basic RAP scores", ylab = "%", font_size = 14)
