---
title: "Profession summary: Data Scientists"
output:
  html_document
---
...
data <- data[!is.na(data$prof_DS) & data$prof_DS == "Yes", ]

tables <- CARS::summarise_all(data, config, all_tables = FALSE)

tmp_dir <- file.path(
  tempdir(),
  janitor::make_clean_names("Data Scientists")
)
...
CARS::create_table_download_zip(
  ...
  label = paste("Download", "Data Scientists", "tables")
)
