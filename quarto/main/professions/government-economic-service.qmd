---
title: "Profession summary: Government Economic Service"
output:
  html_document
---
...
tmp_dir <- file.path(
  tempdir(),
  janitor::make_clean_names("Government Economic Service")
)
...
CARS::create_table_download_zip(
  ...
  label = paste("Download", "Government Economic Service", "tables")
)
