---
title: "Department summary: Department of Health & Social Care (excl. agencies)"
output:
  html_document
---
...
data <- data[!is.na(data$department) & data$department == "Department of Health & Social Care (excl. agencies)", ]
