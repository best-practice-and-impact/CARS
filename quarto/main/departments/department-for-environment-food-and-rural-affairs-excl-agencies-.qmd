...
tmp_dir <- file.path(
  tempdir(),
  janitor::make_clean_names("Department for Environment, Food and Rural Affairs (excl. agencies)")
)
...
CARS::create_table_download_zip(
  ...
  label = paste("Download", "Department for Environment, Food and Rural Affairs (excl. agencies)", "tables")
)
