...
table <- CARS::df_to_table(tables$language_status, n = samples$all, column_headers = c("Programming tool", "Both", "Access only", "Knowledge only", "Neither"), crosstab = TRUE)
...
plot <- CARS::plot_likert(tables$doc, n = samples$code_at_work, mid = 5, neutral_mid = FALSE, break_q_names_col = "name", max_lines = 2, xlab = "%", font_size = 14, height = 600)
...
plot <- CARS::plot_freqs(tables$dependency_management, n = samples$all, break_q_names_col = "value", xlab = "Use dependency management software", ylab = "%", font_size = 14)
...
plot <- CARS::plot_freqs(tables$ci, n = samples$all, break_q_names_col = "value", xlab = "Use continuous integration", ylab = "%", font_size = 14)
...
plot <- CARS::plot_freqs(tables$rep_workflow, n = samples$all, break_q_names_col = "value", xlab = "Use reproduciable workflow packages", ylab = "%", font_size = 14)
...
plot <- CARS::plot_freqs(tables$rap_knowledge, n = samples$all, break_q_names_col = "value", max_lines = 3, xlab = "Knowledge", ylab = "%", font_size = 14, orientation = "h")
...
plot <- CARS::plot_likert(tables$rap_opinions, n = samples$heard_of_RAP, mid = 3, break_q_names_col = "name", max_lines = 2, xlab = "%", font_size = 14, height = 600)
