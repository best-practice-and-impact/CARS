...
plot <- CARS::plot_freqs(tables$code_freq, xlab = "Coding frequency", font_size = 14)
table <- CARS::df_to_table(data = tables, config = config, question = "code_freq")
...
```{r}
plot <- CARS::plot_freqs(tables$git_access, font_size = 14,  xlab = "Access to git") |> CARS::set_axis_range(0, 1, axis = "y")
...
### Knowledge of git
```{r}
plot <- CARS::plot_freqs(tables$git_knowledge, font_size = 14, xlab = "Knowledge of git") |> CARS::set_axis_range(0, 1, axis = "y")
...
This data includes any experience in other roles and sectors, but does not define what type of experience.
