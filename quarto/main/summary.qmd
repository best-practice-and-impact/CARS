...
plot <- CARS::plot_stacked(tables$coding_improve_barriers,  
                           xlab = "Barrier", 
                           colour_scale = "scale", 
                           font_size = 14)

table <- CARS::df_to_table(tables$coding_improve_barriers,  
...
plot <- CARS::plot_stacked(tables$coding_learn_barriers,  
                           xlab = "Barrier", 
                           colour_scale = "scale", 
                           font_size = 14)

table <- CARS::df_to_table(tables$coding_learn_barriers,  
                           column_headers = c("Barrier", "Yes", "No"), 
                           crosstab = TRUE)
...
plot <- CARS::plot_stacked(tables$cloud,  
                           xlab = "Data Platform", 
                           colour_scale = "scale", 
                           font_size = 14)

table <- CARS::df_to_table(tables$cloud,  
...
plot <- CARS::plot_stacked(tables$rap_barriers,  
                           xlab = "Barrier", 
                           colour_scale = "scale", 
                           font_size = 14)

table <- CARS::df_to_table(tables$rap_barriers,  
                           column_headers = c("Barrier", "Yes", "No"), 
                           crosstab = TRUE)
