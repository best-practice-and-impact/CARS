...
plot <- CARS::plot_stacked(tables$access, n = samples$all, xlab = "Programming tool", ylab = "%", font_size = 14)
...
plot <- CARS::plot_stacked(tables$knowledge, n = samples$all, xlab = "Programming tool", ylab = "%", font_size = 14)
table <- CARS::df_to_table(tables$knowledge, n = samples$all, column_headers = c("Programming tool", "Yes", "No", "Don't Know"), crosstab = TRUE)
...
plot <- CARS::plot_stacked(tables$language_status, n = samples$all, xlab = "Programming tool", ylab = "%", font_size = 14)
table <- CARS::df_to_table(tables$language_status, n = samples$all, column_headers = c("Programming tool", "Both", "Access", "Knowledge", "Neither"), crosstab = TRUE)
...
plot <- CARS::plot_freqs(tables$ability_change, n = samples$all, xlab = "Ability change", ylab = "%", font_size = 14)
table <- CARS::df_to_table(tables$ability_change, n = samples$all, column_headers = c("Ability change", "Percent"))
...
plot <- CARS::plot_freqs(tables$where_learned, n = samples$all, xlab = "Where learned", ylab = "%", font_size = 14, orientation = "h")
table <- CARS::df_to_table(tables$where_learned, n = samples$all, column_headers = c("Where learned", "Percent"))
...
plot <- CARS::plot_likert(tables$doc, n = samples$code_at_work, mid = 5, neutral_mid = FALSE, break_q_names_col = "name", max_lines = 3, xlab = "%", font_size = 14, height = 1200)
...
plot <- CARS::plot_freqs(tables$dependency_management, n = samples$all, xlab = "Use dependency management software", ylab = "%", font_size = 14)
table <- CARS::df_to_table(tables$dependency_management, n = samples$all, column_headers = c("Use dependency management software", "Percent"))
...
plot <- CARS::plot_freqs(tables$ci, n = samples$all, xlab = "Use continuous integration", ylab = "%", font_size = 14)
table <- CARS::df_to_table(tables$ci, n = samples$all, column_headers = c("Use continuous integration", "Percent"))
...
plot <- CARS::plot_freqs(tables$rep_workflow, n = samples$all, xlab = "Use reproduciable workflow packages", ylab = "%", font_size = 14)
table <- CARS::df_to_table(tables$rep_workflow, n = samples$all, column_headers = c("Use reproduciable workflow packages", "Percent"))
...
plot <- CARS::plot_freqs(tables$rap_knowledge, n = samples$all, xlab = "Knowledge", ylab = "%", font_size = 14, orientation = "h")
table <- CARS::df_to_table(tables$rap_knowledge, n = samples$all, column_headers = c("Knowledge", "Percent"))
...
plot <- CARS::plot_likert(tables$rap_opinions, n = samples$heard_of_RAP, mid = 5, neutral_mid = FALSE, break_q_names_col = "name", max_lines = 3, xlab = "%", font_size = 14, height = 1200)
...
The count of each respondent’s scores is presented here as “RAP scores”. “Basic components” are the components which make up the RAP MVP. “Advanced components” are components that help improve reproducibility, but were are considered part of the minimum standard.
