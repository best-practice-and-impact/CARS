...
table <- CARS::df_to_table(tables_use, column_headers = c("Programming language", "Use"))
...
plot <- CARS::plot_freqs(tables_knowledge, xlab = "Programming tool knowledge", orientation = "h", font_size = 14)
table <- CARS::df_to_table(tables_knowledge, column_headers = c("Programming language", "Knowledge"))
