---
title: "The state of public sector analysis code: 2022"
output:
  html:
    self-contained: true
---
...
### The majority of respondents regularly use code at work

Over the past three years, the majority of respondents reported coding regularly or all the time to complete work objectives. This may be due in part to respondent bias, where those with an interest in coding are more likely to respond to the survey. However, the results show that coding is now, and has been for at least a few years, a normal aspect of analysis work in the public sector. 
...
- [RAP MVP](rap_mvp_maturity_guidance/Reproducible-Analytical-Pipelines-MVP.md%20at%20master%20·%20best-practice-and-impact/rap_mvp_maturity_guidance%20·%20GitHub)
...
[RAP champions](https://analysisfunction.civilservice.gov.uk/support/reproducible-analytical-pipelines/reproducible-analytical-pipeline-rap-champions/) support and promote the use of RAP across government. Although the majority of respondents who have heard of RAP had heard of the RAP champions' network, most did not know who their RAP champions are. More work is needed to increase awareness of the support available across government, including who its RAP champions are.

Please [contact the analysis standards and pipelines team](mailto:asap@ons.gov.uk) for any inquiries about RAP or the champions network.
...
tables$rap_components %<>% dplyr::arrange(value, n) %>% data.frame
