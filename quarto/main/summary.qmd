...
table <- CARS::df_to_table(data = tables, 
                           ...
                           question = "code_freq",
                           download = TRUE,
                           download_filename = "code-frequency.csv",
...
table <- CARS::df_to_table(data = tables, 
                           ...
                           download = TRUE,
                           download_filename = "code-frequency-pref.csv",
                           download_dir = tmp_dir)
...
tables_knowledge <- tables$knowledge |> 
  dplyr::arrange(value, desc(n)) |>
  dplyr::filter(value == "Yes", name != "None") |>
  dplyr::select(name, n, count, sample)

plot <- CARS::plot_freqs(tables_knowledge, xlab = "Programming tool", orientation = "h", font_size = 14)
table <- CARS::df_to_table(tables_knowledge,  
                           column_headers = c("Programming tool", "Percentage", "Count", "Total"),
                           download = TRUE,
                           download_filename = "code-language-knowledge.csv",
                           download_dir = tmp_dir)
...
plot <- CARS::plot_freqs(tables_use, xlab = "Programming tool use", orientation = "h", font_size = 14)
table <- CARS::df_to_table(tables_use,  
                           column_headers = c("Programming tool", "Percentage", "Count", "Total"),
                           download = TRUE,
                           download_filename = "code-language-use.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(tools_compare[c(1:3)],
                           ...
                           sample = FALSE,
                           download = TRUE,
                           download_filename = "code-language-knowledge-and-use.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(freqs[c(1:3, 6, 7)],
                           ...
                           sample = FALSE,
                           download = TRUE,
                           download_filename = "open-source-vs-propietary-over-time.csv",
                           download_dir = tmp_dir)
...
```{R}
languages_by_prof <- tables$languages_by_prof[c(2,1,3)] |>
  dplyr::filter(Language != "None") |>
  dplyr::arrange(desc(n))

CARS::df_to_table(languages_by_prof, 
            crosstab = TRUE, 
            sample = FALSE,
            heatmap = TRUE,
            percent = FALSE,
            download = TRUE,
            download_filename = "coding-languages-by-profession.csv",
            download_dir = tmp_dir)
```
...
table <- CARS::df_to_table(data = tables$git, 
                           column_headers = c("Do you know how to use Git?", 
                                              ...
                                              "Total"),
                           download = TRUE,
                           download_filename = "git-knowledge.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(data = tables,
                           ...
                           download = TRUE,
                           download_filename = "coding-experience-years.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(data = tables,
                           ...
                           question = "ability_change",
                           download = TRUE,
                           download_filename = "coding-ability-change.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(data = tables, 
                           ...
                           download = TRUE,
                           download_filename = "project-management-confidence.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(data = tables,
                           ...
                           question = "coding_learn_pref",
                           download = TRUE,
                           download_filename = "would-like-to-code-in-role.csv",
                           download_dir = tmp_dir)
...
coding_improve_barriers <- tables$coding_improve_barriers |> 
  dplyr::arrange(value, desc(n)) |>
  dplyr::filter(value == "Yes", name != "Other") |>
  dplyr::select(name, n, count, sample)

plot <- CARS::plot_freqs(coding_improve_barriers,  
                         xlab = "Barrier", 
                         orientation = "h", 
                         font_size = 14)

table <- CARS::df_to_table(coding_improve_barriers,  
                           column_headers = c("Barrier", "Percentage", "Count", "Total"),
                           download = TRUE,
                           download_filename = "learning-to-code-barriers.csv",
                           download_dir = tmp_dir)
...
plot <- CARS::plot_freqs(coding_learn_barriers,  
                         xlab = "Barrier", 
                         orientation = "h", 
                         font_size = 14)
...
table <- CARS::df_to_table(coding_learn_barriers,  
                           column_headers = c("Barrier", "Percentage", "Count", "Total"),
                           download = TRUE,
                           download_filename = "improving-coding-barriers.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(ai_by_prof,
                           column_headers = c("Profession", "Percentage", "Count", "Total"),
                           sample = FALSE,
                           download = TRUE,
                           download_filename = "ai-use-by-profession.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(ai_use_data,
                           column_headers = c("AI use", "Never", "Rarely", "Sometimes", "Regularly", "Always"), 
                           crosstab = TRUE,
                           download = TRUE,
                           download_filename = "how-ai-is-used.csv",
                           download_dir = tmp_dir)
...
cloud <- tables$cloud |> 
  dplyr::arrange(value, desc(n)) |>
  dplyr::filter(value == "Yes", !(name %in% c("None", "Other"))) |>
  dplyr::select(name, n, count, sample)

plot <- CARS::plot_freqs(cloud,  
                         xlab = "Data Platform", 
                         orientation = "h",
                         font_size = 14)

table <- CARS::df_to_table(cloud,  
                           column_headers = c("Data Platform", "Percentage", "Count", "Total"),
                           download = TRUE,
                           download_filename = "cloud-platform-use.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(data = tables, 
                           ...
                           download = TRUE,
                           download_filename = "currently-implementing-rap.csv",
                           download_dir = tmp_dir)
...
plot <- CARS::plot_freqs(rap_barriers,  
                         xlab = "Barrier", 
                         orientation = "h", 
                         font_size = 14)
...
table <- CARS::df_to_table(rap_barriers,  
                           column_headers = c("Barrier", "Percentage", "Count", "Total"),
                           download = TRUE,
                           download_filename = "barriers-to-implementing-rap.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(tables$rap_components,
                           column_headers = c("RAP component",
                                              ...
                                              "Total"),
                           download = TRUE,
                           download_filename = "rap-components.csv",
                           download_dir = tmp_dir)
...
CARS::df_to_table(
  ...
  download = TRUE,
  download_filename = "rap-components-over-time.csv",
  download_dir = tmp_dir
)
...
table <- CARS::df_to_table(tables$coding_practices,
                           ...
                           crosstab = TRUE,
                           download = TRUE,
                           download_filename = "coding-practices.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(tables$doc,
                           ...
                           crosstab = TRUE,
                           download = TRUE,
                           download_filename = "code-documentation.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(tables$working_practices,
                           ...
                           crosstab = TRUE,
                           download = TRUE,
                           download_filename = "good-work-pracices.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(data = tables, 
                           ...
                           question = "standards",
                           download = TRUE,
                           download_filename = "code-quality-standards.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(data = tables, 
                           ...
                           question = "duck_book",
                           download = TRUE,
                           download_filename = "duck-book-awareness.csv",
                           download_dir = tmp_dir)
...
table <- CARS::df_to_table(data = tables, 
                           ...
                           question = "packages",
                           download = TRUE,
                           download_filename = "cross-government-packages.csv",
                           download_dir = tmp_dir)
...
```{r}
CARS::create_table_download_zip(tmp_dir = tmp_dir, zip_file = "summary.zip")
```
