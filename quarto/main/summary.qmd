...
table <- CARS::df_to_table(tables$knowledge,  column_headers = c("Programming tool", "Knowledge"))
...
table <- CARS::df_to_table(tables_use, column_headers = c("Programming tool", "Use"))
