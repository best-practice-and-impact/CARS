...
#CARS::plot_stacked(tables$access, xlab = "Programming tool", colour_scale = "3scale", font_size = 14)
...
likert_ai <- tables$ai_trust
likert_ai$name <- "How much do you trust the accuracy and reliability of outputs from AI tools when coding at work?"
likert_ai <- dplyr::relocate(likert_ai, name) |> dplyr::arrange(desc(dplyr::row_number()))

plot <- CARS::plot_likert(likert_ai,
