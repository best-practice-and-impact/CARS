...
plot <- CARS::plot_freqs(data = tables$time_in_role, 
                   xlab = "How long have you been in your current role?",
                   font_size = 14)

table <- CARS::df_to_table(data = tables, 
                           config = config, 
                           question = "time_in_role")

CARS::wrap_outputs("time-in-role", plot, table)
...
plot <- CARS::plot_freqs(data = tables$rap_implementing, 
                   xlab = "To what extent to you agree with the following statement: 'I am currently implementing RAP in my work'?",
                   font_size = 14)
