...
plot <- CARS::plot_likert(tables$coding_practices, n = samples$code_at_work,
                          ...
                          max_lines = 3, xlab = "%", font_size = 14, height = 725, width = 775)
...
plot <- CARS::plot_likert(tables$doc, n = samples$code_at_work, mid = 5, neutral_mid = FALSE, break_q_names_col = "name", max_lines = 2, xlab = "%", font_size = 14, height = NULL, width = NULL)
...
plot <- CARS::plot_likert(tables$rap_opinions, n = samples$heard_of_RAP, mid = 3, break_q_names_col = "name", max_lines = 2, xlab = "%", font_size = 14, height = NULL, width = NULL)
