...
dummy_data <- data.frame(
  workplace = rep(c("Civil service, including devolved administations", "Office for Students", "NHS"), each=4),
...
test_that("summarise_heard_of_RAP_by_prof output is as expected", {
  ...
  expected <- data.frame(value = factor(c("Data scientists",
                                        ...
                                        levels = c("Data scientists",
                                                   ...
                                                   "Social researchers (GSR)",
                                                   "Statisticians (GSG)")),
                         n = c(1/2, 1/2, 1/2, 1/2, 1/2, 1/2, 1/2, 1/2))
